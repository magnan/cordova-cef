...
//main function
function textFlow(myText,textToAppend,maxWidth,x,ddy,justified,maxlines) {
        ...
        for (i=0;i<words.length;i++) {
                ...
                if (computedTextLength > maxWidth || i == 0) {
						...
						nblines++;	
						if(!maxlines || nblines<maxlines)
						{
                        	tspanEl = document.createElementNS("http://www.w3.org/2000/svg","tspan");
