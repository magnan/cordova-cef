...
___DEF_GLO(4,"write-to-string")
___DEF_GLO(5,"eval")
___DEF_GLO(6,"read")
___DEF_GLO(7,"with-exception-catcher")
___DEF_GLO(8,"with-input-from-string")
___DEF_GLO(9,"with-output-to-string")
___DEF_GLO(10,"write")
___END_GLO
...
#define ___GLO_write_2d_to_2d_string ___GLO(4,___G_write_2d_to_2d_string)
#define ___PRM_write_2d_to_2d_string ___PRM(4,___G_write_2d_to_2d_string)
#define ___GLO_eval ___GLO(5,___G_eval)
#define ___PRM_eval ___PRM(5,___G_eval)
#define ___GLO_read ___GLO(6,___G_read)
#define ___PRM_read ___PRM(6,___G_read)
#define ___GLO_with_2d_exception_2d_catcher ___GLO(7,___G_with_2d_exception_2d_catcher)
#define ___PRM_with_2d_exception_2d_catcher ___PRM(7,___G_with_2d_exception_2d_catcher)
#define ___GLO_with_2d_input_2d_from_2d_string ___GLO(8,___G_with_2d_input_2d_from_2d_string)
#define ___PRM_with_2d_input_2d_from_2d_string ___PRM(8,___G_with_2d_input_2d_from_2d_string)
#define ___GLO_with_2d_output_2d_to_2d_string ___GLO(9,___G_with_2d_output_2d_to_2d_string)
#define ___PRM_with_2d_output_2d_to_2d_string ___PRM(9,___G_with_2d_output_2d_to_2d_string)
#define ___GLO_write ___GLO(10,___G_write)
#define ___PRM_write ___PRM(10,___G_write)
...
#define ___C_LBL_eval_string 17
...
___DEF_GLBL(___L__20_mylib)
   ...
   ___SET_GLO(4,___G_write_2d_to_2d_string,___PRC(8))
   ___SET_GLO(3,___G_read_2d_from_2d_string,___PRC(14))
   ___SET_GLO(2,___G_eval_2d_string,___PRC(17))
   ___SET_R1(___VOID)
...
___DEF_SLBL(1,___L1_catch_2d_all_2d_errors)
   ___ADJFP(-1)
   ___JUMPGLOSAFE(___SET_NARGS(2),7,___G_with_2d_exception_2d_catcher)
___DEF_SLBL(2,___L2_catch_2d_all_2d_errors)
   ___IF_NARGS_EQ(1,___NOTHING)
   ___WRONG_NARGS(2,1,0,0)
   ___POLL(3)
___DEF_SLBL(3,___L3_catch_2d_all_2d_errors)
   ___JUMPGLOSAFE(___SET_NARGS(1),4,___G_write_2d_to_2d_string)
___END_P_SW
___END_P_COD
...
___DEF_SLBL(2,___L2_write_2d_to_2d_string)
   ___ADJFP(-1)
   ___JUMPGLOSAFE(___SET_NARGS(2),9,___G_with_2d_output_2d_to_2d_string)
...
___DEF_SLBL(4,___L4_write_2d_to_2d_string)
   ___JUMPGLOSAFE(___SET_NARGS(1),10,___G_write)
___END_P_SW
___END_P_COD
...
___DEF_SLBL(1,___L1_read_2d_from_2d_string)
   ___JUMPGLOSAFE(___SET_NARGS(2),8,___G_with_2d_input_2d_from_2d_string)
___END_P_SW
___END_P_COD
...
___DEF_SLBL(5,___L5_eval_2d_string)
   ___SET_R0(___LBL(6))
   ___JUMPGLOSAFE(___SET_NARGS(1),5,___G_eval)
